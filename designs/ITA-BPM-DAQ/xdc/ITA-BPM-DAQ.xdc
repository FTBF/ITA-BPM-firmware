...
## Syzygy Port A
set_property -dict { IOSTANDARD LVCMOS33 } [get_ports { scko* }];
set_property -dict { IOSTANDARD LVCMOS33 } [get_ports { sdo* }];
set_property -dict { IOSTANDARD LVCMOS33 } [get_ports { scki }];
set_property -dict { IOSTANDARD LVCMOS33 } [get_ports { sdi }];
set_property -dict { IOSTANDARD LVCMOS33 } [get_ports { cnv }];
...
set_property -dict { PACKAGE_PIN T16  } [get_ports { sdo_0 }]; #IO_L21P_T3_DQS Sch=syzygy_a_d_p[0]
set_property -dict { PACKAGE_PIN T19  } [get_ports { scko_1 }]; #IO_L22N_T3 Sch=syzygy_a_d_n[1]
set_property -dict { PACKAGE_PIN R19  } [get_ports { sdo_1 }]; #IO_L22P_T3 Sch=syzygy_a_d_p[1]
set_property -dict { PACKAGE_PIN T18  } [get_ports { scko_2 }]; #IO_L23N_T3 Sch=syzygy_a_d_n[2]
set_property -dict { PACKAGE_PIN R18  } [get_ports { sdo_2 }]; #IO_L23P_T3 Sch=syzygy_a_d_p[2]
set_property -dict { PACKAGE_PIN P18  } [get_ports { scko_3 }]; #IO_L20N_T3 Sch=syzygy_a_d_n[3]
set_property -dict { PACKAGE_PIN P17  } [get_ports { sdo_3 }]; #IO_L20P_T3 Sch=syzygy_a_d_p[3]
set_property -dict { PACKAGE_PIN R16  } [get_ports { scko_4 }]; #IO_L24N_T3 Sch=syzygy_a_d_n[4]
set_property -dict { PACKAGE_PIN P16  } [get_ports { sdo_4 }]; #IO_L24P_T3 Sch=syzygy_a_d_p[4]
set_property -dict { PACKAGE_PIN P15  } [get_ports { scko_5 }]; #IO_L19N_T3_VREF Sch=syzygy_a_d_n[5]
set_property -dict { PACKAGE_PIN N15  } [get_ports { sdo_5 }]; #IO_L19P_T3 Sch=syzygy_a_d_p[5]
set_property -dict { PACKAGE_PIN K18  } [get_ports { scko_6 }]; #IO_L7N_T1 Sch=syzygy_a_d_n[6]
set_property -dict { PACKAGE_PIN J18  } [get_ports { sdo_6 }]; #IO_L7P_T1 Sch=syzygy_a_d_p[6]
set_property -dict { PACKAGE_PIN K21  } [get_ports { scko_7 }]; #IO_L9N_T1_DQS Sch=syzygy_a_d_n[7]
set_property -dict { PACKAGE_PIN J20  } [get_ports { sdo_7 }]; #IO_L9P_T1_DQS Sch=syzygy_a_d_p[7]
set_property -dict { PACKAGE_PIN M20  } [get_ports { scki }]; #IO_L13N_T2_MRCC Sch=syzygy_a_p2c_clk_n
set_property -dict { PACKAGE_PIN M19  } [get_ports { sdi  }]; #IO_L13P_T2_MRCC Sch=syzygy_a_p2c_clk_p
set_property -dict { PACKAGE_PIN L19  } [get_ports { cnv }]; #IO_L12N_T1_MRCC Sch=syzygy_a_s[16]
